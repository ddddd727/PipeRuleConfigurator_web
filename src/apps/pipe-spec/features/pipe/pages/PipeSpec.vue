...
import PipeSpecConfigButtons from '@/apps/pipe-spec/features/pipe/components/pipe-spec/PipeSpecConfigButtons.vue'
import PipeSpecTreeSearch from '@/apps/pipe-spec/features/pipe/components/pipe-spec/PipeSpecTreeSearch.vue'
import { pipeSpecConfigStore } from '@/apps/pipe-spec/features/pipe/constants/PipeSpec-item'  // 导入管道规格配置存储
import { usePmcTree } from '@/apps/pipe-spec/features/pipe/composables/usePmcTree'
import { usePmcDetails } from '@/apps/pipe-spec/features/pipe/composables/usePmcDetails'
import { useNpdTable } from '@/apps/pipe-spec/features/pipe/composables/useNpdTable'
import { usePreferredRule } from '@/apps/pipe-spec/features/pipe/composables/usePreferredRule'
import { usePmcVersions } from '@/apps/pipe-spec/features/pipe/composables/usePmcVersions'
