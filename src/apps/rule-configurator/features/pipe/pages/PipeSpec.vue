...
import PipeSpecConfigForm from '@/apps/rule-configurator/features/pipe/components/PipeSpecConfigForm.vue'    // 导入 PipeSpecConfigForm 组件，用于配置按钮的弹窗实现
import PipeSpecPreviewForm from '@/apps/rule-configurator/features/pipe/components/PipeSpecPreviewForm.vue'  // 导入规格书预览窗口组件
import PipeSpecNpdTable from '@/apps/rule-configurator/features/pipe/components/pipe-spec/PipeSpecNpdTable.vue'
import PipeSpecConfigButtons from '@/apps/rule-configurator/features/pipe/components/pipe-spec/PipeSpecConfigButtons.vue'
import PipeSpecTreeSearch from '@/apps/rule-configurator/features/pipe/components/pipe-spec/PipeSpecTreeSearch.vue'
import { pipeSpecConfigStore } from '@/apps/rule-configurator/features/pipe/constants/PipeSpec-item'  // 导入管道规格配置存储
import { usePmcTree } from '@/apps/rule-configurator/features/pipe/composables/usePmcTree'
import { usePmcDetails } from '@/apps/rule-configurator/features/pipe/composables/usePmcDetails'
import { useNpdTable } from '@/apps/rule-configurator/features/pipe/composables/useNpdTable'
import { usePreferredRule } from '@/apps/rule-configurator/features/pipe/composables/usePreferredRule'
import { usePmcVersions } from '@/apps/rule-configurator/features/pipe/composables/usePmcVersions'
