...
import { useDirtyData } from '@/apps/rule-configurator/shared/hooks/useDirtyData'
import { useDictCommon } from '@/apps/rule-configurator/features/dict/composables/useDictCommon'
